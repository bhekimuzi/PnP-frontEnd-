...
this.router.navigate(['/my-admin']);
    }else if(this.user.login.role=="User"){
     
      this.router.navigate(['/my-logged']);
    }else if(this.user.login.role=="Supplier") {
      this.router.navigate(['/my-supplier']);
    }else if(this.user.login.role=="DeliveryMan"){
      this.router.navigate(['/my-deliveryMan']);
    }
    },(error)=>{
      this.message =true;
    });
